...
export type AttributesPointsInterface = {
	decrement(attribute: Attribute): void;
	increment(attribute: Attribute): void;
	getAttributes(): Record<Attribute, AttributeModifier>;
	getPoints(): number;
};

export type AttributePointsDto = {
	attributes: Record<Attribute, AttributeModifier>;
	points: number;
};

export class AttributesPoints implements AttributesPointsInterface {
